...
#define STRING_CONFIG_H_AUTHOR "(BrailleRAP, For MKS 2560 based)" // Who made the changes.
...
// Switched to X_MAX plug because the physical endstop is at the max side of the X axis.
// Comment out X_MIN plug and enable X_MAX plug for homing to X_MAX.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80*2, 87, 45, 45 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 100, 300, 25 }
...
// :[-1,1]
// Switched to home to X_MAX (1) because the carriage/endstop sits at the far side.
#define X_HOME_DIR 1
#define Y_HOME_DIR -1
#define Z_HOME_DIR -1
//#define I_HOME_DIR -1
...
#define HOMING_FEEDRATE_MM_M { (20*60*2), (20*60*2), (4*60) }
...
#define BRAILLERAP_DEBUG_ENABLE 0
